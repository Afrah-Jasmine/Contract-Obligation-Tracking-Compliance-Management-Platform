...
import { ObligationDetailComponent } from './pages/obligations/obligation-detail.component';
import { RenewalListComponent } from './pages/renewals/renewal-list.component';
import { RenewalFormComponent } from './pages/renewals/renewal-form.component';
...
export const routes: Routes = [
  ...
  { path:'', component:ShellComponent, canActivate:[authGuard], children:[
    ...
    { path:'obligations/:id/edit', component:ObligationFormComponent },
    { path:'obligations/:id', component:ObligationDetailComponent },
    { path:'renewals', component:RenewalListComponent },
    { path:'renewals/new', component:RenewalFormComponent },
